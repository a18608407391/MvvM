...
import com.buyer.zcommon_module.R;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    /** btn text(按钮内容) */
    protected String btnLeftText = UtilsKt.getContext().getString(R.string.cancle);
    protected String btnRightText =UtilsKt.getContext().getString(R.string.confirm);
    ...
    /** btn textsize(按钮字体大小) */
    protected float leftBtnTextSize_SP = UtilsKt.getSp(15f);
    protected float rightBtnTextSize_SP = UtilsKt.getSp(15f);
    protected float middleBtnTextSize_SP =UtilsKt.getSp(15f);
    ...
    public void setUiBeforShow() {
        ...
        tv_title.setText(TextUtils.isEmpty(title) ? UtilsKt.getContext().getString(R.string.warm) : title);
