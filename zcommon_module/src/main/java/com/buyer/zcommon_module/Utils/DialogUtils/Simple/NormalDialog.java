package com.buyer.zcommon_module.Utils.DialogUtils.Simple;
...
import com.zl.zlibrary.Utils.UtilsKt;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public NormalDialog(Context context) {
        ...
        titleTextSize_SP = UtilsKt.getSp(22);
        contentTextColor = Color.parseColor("#383838");
        contentTextSize_SP = UtilsKt.getSp(17);
    ...
    public View onCreateView() {
        /** title */
        tv_title.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
        ...
        /** content */
        tv_content.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT));
        ll_container.addView(tv_content);

        v_line_horizontal = new View(context);
        v_line_horizontal.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 1));
        ...
        v_line_vertical.setLayoutParams(new LinearLayout.LayoutParams(1, LayoutParams.MATCH_PARENT));
        ...
        v_line_vertical2.setLayoutParams(new LinearLayout.LayoutParams(1, LayoutParams.MATCH_PARENT));
    ...
    public void setUiBeforShow() {
        ...
        /** title underline */
        v_line_title.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
