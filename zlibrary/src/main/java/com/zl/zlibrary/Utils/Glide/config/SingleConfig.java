package com.zl.zlibrary.Utils.Glide.config;
 ...
 */
    ...
    public class SingleConfig {
        ...
        private TransitionFactory animation;
        ...
        public TransitionFactory getAnimation() {
            return animation;
        }
        ...
        public static class ConfigBuilder {
            ...
            public TransitionFactory animation; //动画资源
            ...
            public ConfigBuilder animate(TransitionFactory animation) {
