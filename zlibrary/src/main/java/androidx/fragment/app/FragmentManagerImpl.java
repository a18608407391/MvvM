...
// */
//final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2, FragmentTransition.Callback {
...
//
//    @Override
//    public void onComplete(@NonNull Fragment fragment, @NonNull CancellationSignal signal) {
//
//    }
//
...
//            return true;
//        }
//        FragmentManagerImpl parentFragmentManager = (FragmentManagerImpl) parent.mFragmentManager;
...
//                    !fragment.mHidden, fragment.getNextTransition());
...
//            }
//        }
//        moveToState(f, nextState, f.getNextTransition(), f.getNextTransition(), false);
//
//        if (f.mView != null) {
...
//            FragmentTransition.startTransitions(FragmentManagerImpl.this, records, isRecordPop, startIndex, postponeIndex, true, this);
...
//        if (runTransitions) {
//            FragmentTransition.startTransitions(FragmentManagerImpl.this, records, isRecordPop, 0, 1, true,this);
//        }
//        if (moveToState) {
//            moveToState(mCurState, true);
//        }
...
//        }
//        this.mNextFragmentIndex = fms.mBackStackIndex;
//    }
//
//    /**
...
//        if (parent != null) {
//            mNonConfig = ((FragmentManagerImpl)parent.mFragmentManager).getChildNonConfig(parent);
...
//        if (factory == new FragmentFactory()) {
//            if (mParent != null) {
...
//            FragmentManagerImpl manager = (FragmentManagerImpl) mRecord.mManager;
